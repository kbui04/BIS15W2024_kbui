...
```
## Warning: Unknown or uninitialised column: `asfis_species_name`.
```
...
```
## # A tibble: 1,471 × 2
##    asfis_species_name    species_catch_sum
##    <chr>                             <dbl>
...
Mean catch over all years of every country
...
```
## # A tibble: 199 × 5
##    country               sum_catch yr_min yr_max avg_catch
##    <fct>                     <dbl>  <dbl>  <dbl>     <dbl>
##  1 "Saint Barth\xe9lemy"       300   2007   2012      60  
##  2 "R\xe9union"              11706   1950   2012     189. 
##  3 "C\xf4te d'Ivoire"        19674   1950   2012     317. 
##  4 "Cura\xe7ao"                272   2011   2012     272  
##  5 "Albania"                 17763   1950   2012     286. 
##  6 "Algeria"                 14853   1950   2012     240. 
##  7 "American Samoa"           4444   1974   2012     117. 
##  8 "Angola"                  32974   1950   2012     532. 
##  9 "Anguilla"                 2878   1974   2008      84.6
## 10 "Antigua and Barbuda"      4582   1972   2012     115. 
## # ℹ 189 more rows
```
